...
// Type des onglets disponibles
export type TabType = 'summary' | 'timestampedSummary' | 'transcript' | 'comments';

export class TabManager {
  private container: HTMLElement;
  private tabs: Map<TabType, Tab>;
  ...
  public switchTab(tabType: TabType): void {
    if (this.activeTab === tabType) return; // Ne rien faire si c'est déjà l'onglet actif
